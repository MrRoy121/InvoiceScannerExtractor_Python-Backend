...
if __name__ == "__main__":
    ...
    # file = r'data/invoice.png'
    # img_cropped = cv2.imread(file)

    file = r'resized_image.jpg'
    img_cropped = cv2.imread(file)
    ...
    cv2.rectangle(aligned_img_mask, (35, 300), (730, 620), (0, 0, 255), cv2.FILLED)
    aligned_img_show = cv2.addWeighted(aligned_img_show, 0.99, aligned_img_mask, 0.1, 0)
    img = img_cropped[300:620, 35:730]
