...
def homepage():
    data_set = {'page': 'Home', 'message': "Successfully Loadedsss", 'time': time.time()}
...
def request_page():
    ...
    url_response = urllib.request.urlopen("https://firebasestorage.googleapis.com/v0/b/invoice-scanner-68292.appspot.com/o/images%2F"+file+"&token="+token)
    ...
    time.sleep(10)
    sss = str(form_data.to_json(orient='values')).replace('\\', "")

    print(sss)
    data_set = {'page': 'Request', 'message': sss}
